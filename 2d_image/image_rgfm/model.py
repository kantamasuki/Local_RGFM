...
class sinu_TimeEmbedding(nn.Module):
    ...
    def forward(self, t):
        ...
        freq = torch.arange(half_dim, device=device) / half_dim * math.log(10000)
        freq = torch.exp(-freq)

        emb = t[:, None] * freq[None, :]   # [B, half_dim]
...
class UNet(nn.Module):
    def __init__(
      ...
      out_channels=3
        ...
        tdim = ch * 4
        self.time_embedding = sinu_TimeEmbedding(ch, tdim)
