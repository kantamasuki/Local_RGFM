"""Generate samples from a trained local FM model for the 1D Ising system."""
...
def main():
    parser = argparse.ArgumentParser(description="Generate local FM samples for 1D Ising.")
