"""Evaluate open-boundary two-point correlations for local FM on 1D Ising data."""
...
def main():
    parser = argparse.ArgumentParser(
        description="Evaluate open-boundary two-point correlations for local FM on 1D Ising."
    )
